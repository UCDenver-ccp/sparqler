...
return clojure.string.join.call(null," ",(function (){var iter__5053__auto__ = (function matsu_util$insert_newlines_$_iter__5756(s__5757){
return (new cljs.core.LazySeq(null,(function (){
var s__5757__$1 = s__5757;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__5757__$1);
if(temp__4657__auto__){
var s__5757__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__5757__$2)){
var c__5051__auto__ = cljs.core.chunk_first.call(null,s__5757__$2);
var size__5052__auto__ = cljs.core.count.call(null,c__5051__auto__);
var b__5759 = cljs.core.chunk_buffer.call(null,size__5052__auto__);
if((function (){var i__5758 = (0);
while(true){
if((i__5758 < size__5052__auto__)){
var elem = cljs.core._nth.call(null,c__5051__auto__,i__5758);
var e = cljs.core.first.call(null,elem);
cljs.core.chunk_append.call(null,b__5759,((cljs.core.contains_QMARK_.call(null,matsu_util.before2,e))?[cljs.core.str("\n \n"),cljs.core.str(e)].join(''):((cljs.core.contains_QMARK_.call(null,matsu_util.before,e))?[cljs.core.str("\n"),cljs.core.str(e)].join(''):((cljs.core.contains_QMARK_.call(null,matsu_util.after,e))?[cljs.core.str(e),cljs.core.str("\n")].join(''):((cljs.core.contains_QMARK_.call(null,matsu_util.both,e))?[cljs.core.str("\n"),cljs.core.str(e),cljs.core.str("\n")].join(''):e
)))));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__5759),matsu_util$insert_newlines_$_iter__5756.call(null,cljs.core.chunk_rest.call(null,s__5757__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__5759),null);
}
} else {
var elem = cljs.core.first.call(null,s__5757__$2);
var e = cljs.core.first.call(null,elem);
return cljs.core.cons.call(null,((cljs.core.contains_QMARK_.call(null,matsu_util.before2,e))?[cljs.core.str("\n \n"),cljs.core.str(e)].join(''):((cljs.core.contains_QMARK_.call(null,matsu_util.before,e))?[cljs.core.str("\n"),cljs.core.str(e)].join(''):((cljs.core.contains_QMARK_.call(null,matsu_util.after,e))?[cljs.core.str(e),cljs.core.str("\n")].join(''):((cljs.core.contains_QMARK_.call(null,matsu_util.both,e))?[cljs.core.str("\n"),cljs.core.str(e),cljs.core.str("\n")].join(''):e
)))),matsu_util$insert_newlines_$_iter__5756.call(null,cljs.core.rest.call(null,s__5757__$2)));
}
} else {
return null;
}
...
var G__5761 = cljs.core.rest.call(null,lines);
var G__5762 = cljs.core.conj.call(null,result,[cljs.core.str(same_subject),cljs.core.str(indentstring),cljs.core.str(line)].join(''));
var G__5763 = (cljs.core.truth_(add_indent)?add_indent:(cljs.core.truth_(remove_indent)?remove_indent:indent
));
var G__5764 = (cljs.core.truth_(semicolon)?semicolon:"");
lines = G__5761;
result = G__5762;
indent = G__5763;
same_subject = G__5764;
continue;
}
break;
}
